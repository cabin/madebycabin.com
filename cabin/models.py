...
SERVICES = [
    ...
    Service(13, 'pln', 'Information architecture'),
    Service( 6, 'pln', 'Prioritization and metrics'),
    Service( 7, 'pln', 'Training and education'),

    Service( 9, 'dsn', 'Branding and identity'),
    Service( 4, 'dsn', 'Content development'),
    Service(16, 'dsn', 'Rapid prototyping'),
    Service(14, 'dsn', 'Experience design'),
    Service(15, 'dsn', 'Web and mobile design'),
    Service(18, 'dsn', 'Data visualization'),
    Service(17, 'dsn', 'Usability testing'),
    Service(12, 'dsn', 'Print and packaging'),
    Service(11, 'dsn', 'Signage and environmental'),
    Service(30, 'dsn', 'Copywriting'),
